 ...
 * between coiniumd, and coinium-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), COINIUM_CONF_FILENAME));
    if (mode == HMM_COINIUMD)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), COINIUM_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/coinium/coinium>";
    const std::string URL_WEBSITE = "<https://coiniumcore.org>";
...
/** Sanity checks
 *  Ensure that Coinium is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Coinium process is using the data directory.
