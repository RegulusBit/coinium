 ...
 */
#ifndef COINIUM_UTIL_H
#define COINIUM_UTIL_H
...
extern const char * const COINIUM_CONF_FILENAME;
extern const char * const COINIUM_PID_FILENAME;
...
{
    std::string s = strprintf("coinium-%s", name);
