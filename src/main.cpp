...
#if defined(NDEBUG)
# error "Coinium cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Coinium Signed Message:\n";
                     ...
                     ++mi)
                {
                    ...
                    else if (!fMissingInputs2)
                    {
                        ...
                        if (orphanTx.wit.IsNull() && !stateDummy.CorruptionPossible()) {
                            ...
                            // See https://github.com/coinium/coinium/issues/8279 for details.
                            assert(recentRejects);
