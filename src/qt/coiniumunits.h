...
#ifndef COINIUM_QT_COINIUMUNITS_H
#define COINIUM_QT_COINIUMUNITS_H
...
/** Coinium unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CoiniumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CoiniumUnits(QObject *parent);

    /** Coinium units.
      @note Source: https://en.coinium.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        UTB,
...
typedef CoiniumUnits::Unit CoiniumUnit;

#endif // COINIUM_QT_COINIUMUNITS_H
