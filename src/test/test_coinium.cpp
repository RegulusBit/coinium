...
#define BOOST_TEST_MODULE Coinium Test Suite

#include "test_coinium.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_coinium_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
