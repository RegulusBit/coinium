...
#ifndef COINIUM_TEST_SCRIPTNUM10_H
#define COINIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Coinium Core 0.10.0, for cross-comparison.
 */
public:
