...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CCoiniumAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CCoiniumAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CCoiniumAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CCoiniumAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CCoiniumAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CCoiniumAddress(arr[0].get_str()).Get() == demoAddress.Get());
