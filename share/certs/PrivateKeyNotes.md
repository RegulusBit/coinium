...
unlocked to sign the Coinium-Qt.app bundle.
...
allowing somebody to distribute a Coinium-Qt.app or coinium-qt-setup.exe with a valid
...
that the coinium-qt.exe file inside the installer had not been tampered with.
