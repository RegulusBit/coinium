...
class RawTransactionsTest(CoiniumTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid coinium address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid coinium address" in e.error['message'])
