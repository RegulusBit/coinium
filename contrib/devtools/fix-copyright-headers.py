...
// Copyright (c) 2009-2012 The Coinium Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Coinium/$1-%s The Coinium/' %s"
REGEX_CURRENT= re.compile("%s The Coinium" % year)
